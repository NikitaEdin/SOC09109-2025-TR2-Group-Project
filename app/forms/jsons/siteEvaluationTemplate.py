    ...
    "sections": [
...

      {
          ...
          "fields": [
              ...
              {"id": "sensitivies", "name": "Sensitives", "value": "", "type": "textarea",
              ...
              {"id": "terrian", "name":"Terrain", "value": "", "type": "textarea",
               "description": "This will be useful to identify and additional permission needed if looking to operate within."},
              {"id": "aviationproximities", "name":"Aviation proximitys", "value": "", "type": "textarea",
               "description": "What is the distance and direction to places where people non under your control could be found?",
               "tooltip": "This would be a brief overview of any other airspace proximitys"},
              {"id": "permissions", "name":"Permissions", "value": "", "type": "textarea",
               "description": "Do you have permission to operate from that location you should be aware of any issues around bylaws and trespass. "},
...

      {
          ...
          "fields": [
              ...
              {"id": "hospital", "name":"Local Hospital", "value": "", "type": "textarea",
